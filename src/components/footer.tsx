...
export default function Footer() {
    return (
        <footer className="min-w-5xl mx-auto relative flex justify-center">
            <svg
                viewBox="0 0 959 186"
                fill="none"
            ...
            <div className="flex justify-center gap-6 w-full z-10 py-8 max-w-150">
                <h2 className="text-2xl font-bold">Pronto para construir o seu <span className="text-accent">futuro?</span></h2>
