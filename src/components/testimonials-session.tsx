...
export default function TestimonialsSession() {
    return (
        <section className="relative w-full">
            ...
            <div className="container p-12 flex flex-1 gap-4">
                <div className="relative h-fit min-w-64">
                    <h2 className="text-2xl font-bold">O que nossa comunidade diz</h2>
                    <svg
                        viewBox="0 0 200 8"
                        fill="none"
                        className="absolute -bottom-2 left-0 -right-2 text-primary"
                    >
                        <path
                            stroke="currentColor"
                            strokeWidth="1"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Testemunhos serão adicionados aqui */}
            ...
            <svg
                ...
                viewBox="0 0 181 132"
                fill="none"
                className="absolute -left-2 bottom-0 text-primary"
            >
            ...
            <svg
                ...
                viewBox="0 0 83 134"
                fill="none"
                className="absolute top-0 -right-2 text-destructive"
            >
